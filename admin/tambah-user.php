...
if (isset($_POST['submit'])) {
    ...
    // select data dari Level lalu input ke table user
...
if (isset($_POST['edit'])) {
    ...
    // Edit data dari Level lalu input ke table user
    $dataLevel = mysqli_query($conn, "SELECT nama_level FROM level WHERE id ='$id_level'");
    $rowLevel = mysqli_fetch_assoc($dataLevel);
    $nama_level = $rowLevel['nama_level'];
    ...
    $update = mysqli_query($conn, "UPDATE user SET id_level='$id_level',nama_level='$nama_level', nama_lengkap='$nama_lengkap', password='$password', email='$email' WHERE id='$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo isset($_GET['edit']) ? 'Edit' : 'Tambah' ?> user </h1>
                                ...
                                <div class="card-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="">Input Level Pengguna</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user"
                                                id="" aria-describedby="" name="nama_lengkap"
                                                placeholder="" value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_lengkap'] : '' ?>">
                                        </div>
                                        <div class="form-group">
